...
/**
 * Builder of {@link org.opensaml.xml.encryption.KeyDerivationMethod}.
 */
public class KeyDerivationMethodBuilder extends AbstractXMLObjectBuilder<KeyDerivationMethod> implements
    ...
    public KeyDerivationMethod buildObject() {
        return buildObject(XMLConstants.XMLENC11_NS, KeyDerivationMethod.DEFAULT_ELEMENT_LOCAL_NAME,
