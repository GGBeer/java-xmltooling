...
/**
 * Checks {@link XSHexBinary} for Schema compliance. 
 * 
 * @param <T> the type to be validated
 */
public class XSHexBinarySchemaValidator<T extends XSHexBinary> implements Validator<T> {
     ...
     */
    public XSHexBinarySchemaValidator(boolean allowEmptyElementContent) {
     ...
     *
     */
    public XSHexBinarySchemaValidator() {
        allowEmptyContent = false;
    }

    /** {@inheritDoc} */
    public void validate(T xmlObject) throws ValidationException {
        validateHexBinaryContent(xmlObject);
    }
    ...
    /**
     * Validates the content of the XSHexBinary object.
     * 
     * @param xmlObject the object to evaluate
     * @throws ValidationException thrown if the content of the HexBinary object is invalid
     */
    protected void validateHexBinaryContent(T xmlObject) throws ValidationException {
        if (! isAllowEmptyContent()) {
            if (DatatypeHelper.isEmpty(xmlObject.getValue())) {
                throw new ValidationException("HexBinary content may not be empty");
            }
        }
    }
