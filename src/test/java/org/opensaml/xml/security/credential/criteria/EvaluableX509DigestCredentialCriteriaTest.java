 ...
 *
 */
public class EvaluableX509DigestCredentialCriteriaTest extends TestCase {
    ...
    private X509DigestCriteria criteria;
    ...
    public EvaluableX509DigestCredentialCriteriaTest() {
    ...
    protected void setUp() throws Exception {
        ...
        entityCertDigest = Base64.decode(entityCertDigestBase64);
        
        credential = new BasicX509Credential();
        credential.setEntityCertificate(entityCert);
        
        criteria = new X509DigestCriteria(digestAlgorithm, entityCertDigest);
    }
    
    public void testSatisfy() {
        EvaluableX509DigestCredentialCriteria evalCrit = new EvaluableX509DigestCredentialCriteria(criteria);
