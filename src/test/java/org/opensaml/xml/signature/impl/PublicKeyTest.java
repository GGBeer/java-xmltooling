...
public class PublicKeyTest extends XMLObjectProviderBaseTestCase {
    ...
    public PublicKeyTest() {
        singleElementFile = "/data/org/opensaml/xml/signature/impl/PublicKey.xml";
    ...
    public void testSingleElementUnmarshall() {
        ...
        assertNotNull("PublicKey", cbType);
        assertEquals("PublicKey value", cbType.getValue(), expectedCryptoBinaryContent);
    }
